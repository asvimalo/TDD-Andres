    ...
    public class Bank
    {
        ...
        public void CreateAccount(Account account)
        {
            ...
            if (int.TryParse(account.Number, out num) == false)
            {
                ...
                Logs.Add("Warn12: CreateAccount, Invalid account number received");
                _auditlogger.AddMessage("Error45: Alert, internal error, should not happen!");
                Logs.Add("Error45: Alert, internal error, should not happen!");
                throw new InvalidAccount();
            }

            _accounts.Add(account.Number, account);
            Logs.Add("New account, Account number " + account.Number + ", Name=" + account.Name);
